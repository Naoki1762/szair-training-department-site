"""Django settings for the Shenzhen Airlines training portal."""
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-local-training-platform-change-in-production",
)
...
if os.environ.get("DB_ENGINE", "sqlite").lower() == "mysql":
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("MYSQL_DATABASE", "szair_training"),
            "USER": os.environ.get("MYSQL_USER", "szair_training"),
